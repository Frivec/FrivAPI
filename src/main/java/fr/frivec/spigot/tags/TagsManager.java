...
public class TagsManager {
	...
	public TagsManager(String name, ChatColor nameColor, String prefix, String suffix, Scoreboard current) throws Exception {
		this.prefix = prefix;
		this.suffix = suffix;
		...
		if(nameColor != null)
			...
			this.team.setColor(nameColor);
	}
	
	public TagsManager(String name, ChatColor nameColor, String prefix, String suffix) throws Exception {
	...
	public static void setNameTag(Player player, String name, ChatColor nameColor, String prefix, String suffix){
		...
		try{
			...
			TagsManager tagplayer = new TagsManager(name, nameColor, prefix, suffix);
